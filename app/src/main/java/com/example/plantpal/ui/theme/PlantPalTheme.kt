...
val LightPlantSurface = Color(0xFFE8F6D4)
val MediumPlantSurface = Color(0xFFCDECC0)
...
val LightColors = lightColorScheme(
    ...
    surface = LightPlantSurface,
    onSurface = Charcoal,

    surfaceVariant = MediumPlantSurface,
...
val DarkColors = darkColorScheme(
    ...
    surface = Color(0xFF3A4A34),
    onSurface = Color(0xFFEAF7F0),

    surfaceVariant = Color(0xFF2E3C29),
